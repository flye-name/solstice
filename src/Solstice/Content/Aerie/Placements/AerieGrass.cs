...
public class AerieGrassSeeds : ModItem
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        SolsticeItemSets.TileReplacements[Type] = new SolsticeItemSets.TileReplacementInfo(true, grass_replacements);
    }
...
public sealed class TallAerieGrassSeeds<T> : ModItem where T : ModTile
{
    ...
    public override void SetStaticDefaults()
    {
        ...
        SolsticeItemSets.SwapsTo[Type] = new SolsticeItemSets.ItemSwapInfo(next, true, SoundID.Grass);

        int[] similar = TallAerieGrassHelper.AlternateSeedItems.Select(i => i.Type).Append(parent).ToArray();

        SolsticeItemSets.CountsAs[Type] = similar;

        SolsticeItemSets.StaticFrame[Type] = ItemFrame;
    }
